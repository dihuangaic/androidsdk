...
public class PatientRollingAdherenceDto {
    ...
    @com.google.gson.annotations.SerializedName("rollingDays")
    private Integer rollingDays = null;
    ...
    /**
     * Sets the value of rollingDays.
     *
     * @param rollingDays the new value
     */
